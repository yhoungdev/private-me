    ...
    return (
        <>
            ...
            <ContainerLayout>
                   ...
                   <Box>
                         <Text fontWeight={'bold'} fontSize={['50px','80px']}
                  ...
                  <Box bg={'var(--dark-shade)'} p={'2em'} 
                         mx={'auto'} my={'3em'}
                         borderRadius={'0.5em'} w={['100%', '60%']}>
                        ...
                        <Flex gap={'4'} my={'2em'} flexDir={[ 'row']} alignItems={'center'}>
                          ...
                          <Box>
                            ...
                            <Text overflowWrap={'anywhere'} my={'0.5em'} color={'#CBCBCB'}> 0x456061F47628bA970A97394DeC87a1685A996A58 </Text>
                       ...
                       <Text color={'#9B9B9B !important'}>
                             Privacy should be Number 1 Human Right, in this World of illusion called the internet, there is nothing like privacy and security dosnt exist in the internet 
                       </Text>
